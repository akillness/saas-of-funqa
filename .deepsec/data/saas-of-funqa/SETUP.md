# Agent setup for `saas-of-funqa`

This is a deepsec scanning workspace. Project `saas-of-funqa` was just registered
(target: `..`). Setup is incomplete — `data/saas-of-funqa/INFO.md`
...
2. **Fill in `data/saas-of-funqa/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id saas-of-funqa
pnpm deepsec process --project-id saas-of-funqa
```
