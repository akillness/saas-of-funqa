export const koMessages = {
  ...
  vectorIndex: {
    ...
    title: "영상을 검색 가능한 벡터로 저장합니다.",
    lede:
      "영상 파일을 올리면 브라우저가 대표 프레임을 뽑고, 서버가 각 장면을 설명한 뒤 임베딩으로 변환해 장면 벡터 저장소에 기록합니다.",
    boundary:
    ...
    contractItems: [
      ...
      "비전 모델이 생성한 장면 캡션",
      "캡션 임베딩 벡터",
      "멀티모달 모델일 때는 이미지 임베딩 벡터도 함께",
      "임베딩 모드·모델명(다른 공간은 검색에서 제외됨)"
    ],
    storageNote:
  ...
  patchDesk: {
    eyebrow: "게임 로그 근거 데스크",
    title: "패치 데스크",
    lede: "무엇이 바뀌었는지 묻고, 모든 주장을 로그로 추적한 뒤, 검증된 맥락을 다음 질문으로 이어 가세요.",
    starterP42: "P42에서 Scout 대시 재사용 대기시간은 어떻게, 왜 바뀌었나요?",
    starterIncident184: "Incident 184의 원인은 무엇이었고 어떻게 해결했나요?",
    starterNewest: "가장 최근 Scout 플레이테스트를 요약해 주세요.",
    queryLabel: "게임 로그에 질문하기",
    queryPlaceholder: "패치, 플레이테스트, 인시던트 또는 결정에 관해 질문하세요…",
    search: "로그 검색",
    shortcut: "/ 키로 입력창에 포커스",
    scopeLabel: "범위",
    entityLabel: "프로젝트 또는 엔터티",
    timeLabel: "시간 범위",
    sourcesLabel: "로그 소스",
    noScopeDelta: "범위 변경 없음",
    changedPrefix: "변경:",
    notSet: "설정되지 않음",
    showAllScope: "전체 범위 보기",
    serviceChecking: "로컬 근거 서비스를 확인하는 중…",
    serviceReady: "로컬 근거 서비스 준비됨",
    retrievalOffline: "로컬 검색 오프라인",
    ...
    dispatchStarted: "디스패치 시작됨",
    searching: "인덱싱된 로그를 검색하는 중…",
    ranking: "로그 조각을 찾았습니다. 근거 순위를 정하는 중…",
    synthesizing: "{count}개 로그 조각으로 결과를 작성하는 중…",
    stop: "검색 중지",
    stopped: "검색이 중지되었습니다. 검색된 근거는 보존됩니다.",
    supportedTitle: "근거가 확인된 결과",
    supportedBody: "아래의 모든 핵심 주장은 인덱싱된 로그로 추적됩니다.",
    inspectTraces: "주장 추적 보기",
    noHitsTitle: "일치하는 로그 조각 없음",
    noHitsBody: "이 범위와 일치하는 인덱싱된 로그 근거가 없습니다.",
    weakTitle: "근거 발견, 결과 보류",
    weakBody: "로그 조각은 찾았지만 신뢰할 수 있는 결과를 뒷받침하지 못합니다.",
    retrievalUnavailableTitle: "아카이브 검색 불가",
    retrievalUnavailableBody: "로컬 검색 경로에서 인덱싱된 로그를 검색하지 못했습니다.",
    synthesisUnavailableTitle: "결과 작성 불가, 근거 보존됨",
    synthesisUnavailableBody: "로그 조각은 있지만 로컬 모델이 결과를 작성하지 못했습니다.",
    staleTitle: "아카이브가 최신이 아닐 수 있음",
    staleBody: "{timestamp} 이후의 로그는 결과에서 빠질 수 있습니다.",
    ageWarning: "아카이브를 새로 고친 지 24시간 이상 되었습니다.",
    broadenScope: "범위 넓히기",
    refineQuery: "질문 다듬기",
    retryRetrieval: "검색 다시 시도",
    openRawEvidence: "원본 근거 열기",
    refreshArchive: "아카이브 새로 고침",
    claimsLabel: "주장",
    traceRailLabel: "주장 추적",
    logShardLabel: "로그 조각",
    freshnessLabel: "아카이브 새로 고침",
    superseded: "{evidenceId}로 대체됨",
    untrusted: "신뢰할 수 없는 로그 텍스트 — 데이터이며 지시가 아님",
    sourceLabel: "소스 로그",
    eventTimeLabel: "이벤트 시간",
    rankLabel: "순위",
    scoreLabel: "검색 점수",
    excerptBoundsLabel: "발췌 범위",
    queryIdLabel: "질문 ID",
    correlationIdLabel: "상관관계 ID",
    relationLabel: "주장 관계",
    relationSupports: "뒷받침",
    relationContradicts: "반박",
    relationSupersedes: "대체",
    relationContext: "맥락만 제공",
    relationUntrusted: "신뢰할 수 없는 데이터",
    followUpLabel: "후속 질문하기",
    parentQueryLabel: "이전 디스패치",
    dispatchTrail: "디스패치 기록",
    reviseQuery: "질문 수정",
    saveCard: "근거 카드 저장",
    copyEvidence: "근거 링크 복사",
    acknowledge: "경계 노트 확인",
    dispatchDetails: "디스패치 세부 정보",
    backToClaim: "주장으로 돌아가기",
    inspectBeforeSave: "저장하기 전에 주장 추적을 확인하세요.",
    ...
    checkingState: "확인 중",
    offlineState: "오프라인",
    checkedAtLabel: "확인 시각",
    ownerLabel: "담당",
    retrievalOwner: "검색",
    synthesisOwner: "합성",
    noFailureOwner: "실패 담당 없음",
    activeOwner: "현재 담당",
    projectLabel: "프로젝트",
    projectPlaceholder: "쉼표로 구분한 프로젝트 ID",
    entityPlaceholder: "쉼표로 구분한 엔터티 ID",
    sourcePlaceholder: "쉼표로 구분한 소스 ID",
    timeFromLabel: "시작",
    timeToLabel: "종료",
    snapshotLabel: "인덱스 스냅샷",
    allProjects: "모든 프로젝트",
    allEntities: "모든 엔터티",
    allSources: "인덱싱된 모든 로그",
    scopeFrozen: "디스패치가 시작되면 범위가 고정됩니다.",
    findingLabel: "결과",
    boundaryNoteLabel: "경계 노트",
    reasonLabel: "이유 코드",
    stageLabel: "디스패치 단계",
    stopping: "검색을 중지하는 중…",
    initialTitle: "디스패치 열기",
    initialBody: "시작 질문을 고르거나 기록된 게임 변경 사항을 아카이브에 질문하세요.",
    searchNeedsService: "로컬 검색과 합성이 모두 준비되면 검색을 사용할 수 있습니다.",
    evidenceEmpty: "이 디스패치에 사용할 로그 조각이 없습니다.",
    rawEvidenceLabel: "원본 근거",
    linkedEvidenceLabel: "연결된 로그 조각",
    excerptLabel: "발췌문",
    pathLabel: "소스 경로",
    trustLabel: "신뢰 분류",
    indexSnapshotLabel: "스냅샷",
    coverageLabel: "포함 범위",
    evidenceSetLabel: "근거 세트",
    modelProfileLabel: "모델 프로필",
    quantizationLabel: "양자화",
    contextTokensLabel: "컨텍스트 한도",
    inputTokensLabel: "근거 입력 토큰",
    outputTokensLabel: "출력 토큰",
    truncationLabel: "잘림",
    unknownValue: "알 수 없음",
    dispatchCurrent: "현재 디스패치",
    dispatchAccepted: "수락됨",
    dispatchRunning: "실행 중",
    dispatchCompleted: "완료됨",
    dispatchCancelled: "취소됨",
    noDispatches: "아직 디스패치가 없습니다.",
    revisionPlaceholder: "질문을 유지하거나 더 좁은 후속 질문을 하세요…",
    parentScopeLabel: "상속된 범위",
    scopeDeltaLabel: "범위 변경",
    entityAdded: "추가된 엔터티",
    entityRemoved: "제외된 엔터티",
    sourcesAdded: "추가된 소스",
    sourcesRemoved: "제외된 소스",
    timeFromChanged: "시작 시각 변경",
    timeToChanged: "종료 시각 변경",
    cardSaved: "근거 카드를 저장했습니다.",
    linkCopied: "근거 링크를 복사했습니다.",
    boundaryAcknowledged: "경계 노트를 확인했습니다.",
    rewardStatusLabel: "해결 상태",
